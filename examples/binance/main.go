...
func main() {
	...
	if apiKey == "" || secretKey == "" {
		fmt.Println("Warning: BINANCE_API_KEY and BINANCE_SECRET_KEY environment variables are not set")
	...
	exchange, err := exlink.NewExchange(exlink.ExchangeBinance, opts...)
	if err != nil {
