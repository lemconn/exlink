...
func openLongPosition(ctx context.Context, exchange base.Exchange, symbol string, amount float64) {
	...
	order, err := exchange.CreateOrder(ctx, symbol, types.OrderSideBuy, types.OrderTypeMarket, strconv.FormatFloat(amount, 'f', -1, 64), "0", types.WithSize(size))
	if err != nil {
...
func closeLongPosition(ctx context.Context, exchange base.Exchange, symbol string, amount float64) {
	...
	order, err := exchange.CreateOrder(ctx, symbol, types.OrderSideSell, types.OrderTypeMarket, strconv.FormatFloat(amount, 'f', -1, 64), "0", types.WithSize(size), types.WithReduceOnly(true))
	if err != nil {
...
func openShortPosition(ctx context.Context, exchange base.Exchange, symbol string, amount float64) {
	...
	order, err := exchange.CreateOrder(ctx, symbol, types.OrderSideSell, types.OrderTypeMarket, strconv.FormatFloat(amount, 'f', -1, 64), "0", types.WithSize(size))
	if err != nil {
...
func closeShortPosition(ctx context.Context, exchange base.Exchange, symbol string, amount float64) {
	...
	order, err := exchange.CreateOrder(ctx, symbol, types.OrderSideBuy, types.OrderTypeMarket, strconv.FormatFloat(amount, 'f', -1, 64), "0", types.WithSize(size), types.WithReduceOnly(true))
	if err != nil {
